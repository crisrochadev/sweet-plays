    ...
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
      ...
      <div class="flex items-center justify-center">
        <button
          ...
          type="button"
          class="inline-flex items-center justify-center w-10 h-10 font-medium bg-cyan-600 rounded-full hover:bg-cyan-700 group focus:ring-4 focus:ring-cyan-300 focus:outline-none dark:focus:ring-cyan-800"
        >
      ...
      >
        ...
        <p
          v-else
          class="font-extrabold text-cyan-600 text-4xl uppercase bg-cyan-200 rounded-full w-8 h-8 pb-2 flex justify-center items-center"
        >
          {{ getNameUser(user) }}
        </p>
        <span class="sr-only">Ranking</span>
